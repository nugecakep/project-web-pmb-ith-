                ...
                <div class="container-fluid p-0">
                    <div class="row align-items-center no-gutters">
                        <div class="col-xl-2 col-lg-2">
                            <div class="logo-img">
                                <a href="index.html">
                                    <img src="assets2/img/ii.png" alt="">
                                </a>
                            </div>
                        </div>
                ...
                <div class="row align-items-center justify-content-center">
                    <div class="col-xl-6 col-md-6">
                        <div class="illastrator_png">
                            <img src="assets2/img/banner/ii2.png" alt="">
                        </div>
                    </div>
                    <div class="col-xl-6 col-md-6">
                        <div class="slider_info">
                            <h3>PENERIMAAN MAHASISWA BARU<h2>
                                INSTITUT TEKNOLOGI BAHCARUDDIN JUSUF HABIBIE (ITH) <h2>
    ...
    <form id="test-form" class="white-popup-block mfp-hide" method="post" action="">
        <div class="popup_box mx-auto d-block">
            <div class="popup_inner">
                ...
                <p class="text-center doen_have_acc"><a class="dont-hav-acc" href="#test-form2">Belum Punya Akun PMB ITH? Ayo Daftar !!</a>
                </p>
            </div>
        </div>
    <!-- form itself end -->
